...
const LOCATIONS: &[Location] = &[
    Location { name: "new_york", latitude: 40.7128, longitude: -74.0060 },
    Location { name: "los_angeles", latitude: 34.0522, longitude: -118.2437 },
    Location { name: "chicago", latitude: 41.8781, longitude: -87.6298 },
    Location { name: "houston", latitude: 29.7604, longitude: -95.3698 },
    Location { name: "phoenix", latitude: 33.4484, longitude: -112.0742 },
    Location { name: "philadelphia", latitude: 39.9526, longitude: -75.1652 },
    Location { name: "san_antonio", latitude: 29.4241, longitude: -98.4936 },
    Location { name: "san_diego", latitude: 32.7157, longitude: -117.1611 },
    Location { name: "dallas", latitude: 32.7767, longitude: -96.7970 },
    Location { name: "san_jose", latitude: 37.3382, longitude: -121.8863 },
    Location { name: "austin", latitude: 30.2672, longitude: -97.7431 },
    Location { name: "jacksonville", latitude: 30.3322, longitude: -81.6557 },
    Location { name: "fort_worth", latitude: 32.7555, longitude: -97.3308 },
    ...
    Location { name: "detroit", latitude: 42.3314, longitude: -83.0458 },
    Location { name: "memphis", latitude: 35.1495, longitude: -90.0490 },
    ...
    Location { name: "google_hq", latitude: 37.4220, longitude: -122.0841 },
    Location { name: "apple_hq", latitude: 37.3346, longitude: -122.0097 },
    Location { name: "microsoft_hq", latitude: 47.6202, longitude: -122.3212 },
    Location { name: "amazon_hq", latitude: 47.6150, longitude: -122.3324 },
    Location { name: "meta_hq", latitude: 37.4847, longitude: -122.1477 },
    // Warehouse locations
    Location { name: "warehouse_nyc", latitude: 40.6892, longitude: -74.0445 },
    Location { name: "warehouse_la", latitude: 33.9186, longitude: -118.2105 },
    Location { name: "warehouse_chicago", latitude: 41.8782, longitude: -87.6292 },
    Location { name: "warehouse_dallas", latitude: 32.8156, longitude: -96.8473 },
    Location { name: "warehouse_atlanta", latitude: 33.7490, longitude: -84.3880 },
    Location { name: "distribution_nj", latitude: 40.2206, longitude: -74.7597 },
    Location { name: "distribution_pa", latitude: 40.4406, longitude: -79.9959 },
    Location { name: "distribution_ga", latitude: 33.6407, longitude: -84.4277 },
    Location { name: "distribution_ca", latitude: 35.3733, longitude: -119.0187 },
    Location { name: "distribution_tx", latitude: 32.7555, longitude: -97.3308 },
];
...
mod tests {
    ...
    fn test_geospatial_location_cardinality() {
        ...
        let locations: std::collections::HashSet<_> = data.iter()
    ...
    fn test_geospatial_accuracy_rle_optimal() {
        ...
        let accuracy_values: Vec<f32> = data.iter()
        ...
        let unique_accuracies: std::collections::HashSet<i32> = accuracy_values.iter()
    ...
    fn test_geospatial_delta_optimal_coordinates() {
        ...
        let mut location_coords: std::collections::HashMap<i64, Vec<(f64, f64)>> = std::collections::HashMap::new();
        for point in &data {
    ...
    fn test_geospatial_device_distribution() {
        ...
        let devices: std::collections::HashSet<_> = data.iter()
        ...
        for point in &data {
            *device_counts.entry(point["device_id"].as_i64().unwrap())
                .or_insert(0) += 1;
        }
